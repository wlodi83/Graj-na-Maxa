...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :subscription, 'Subscription', subscriptions_path, :if => Proc.new { user_signed_in? }
    primary.item :admin_games, 'Admin Games', games_admin_path, :if => Proc.new { current_user.try(:admin?) }
    primary.item :admin_comments, 'Admin Comments', comments_path, :if => Proc.new { current_user.try(:admin?) }
